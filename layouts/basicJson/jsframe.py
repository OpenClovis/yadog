...
def main(obj,cfg,tagdict):
  ...
  if (1):
    ...
    shutil.copy(mediaDir+"/medlogo.png","html/")
    ...
    sidebarContent=HSplit([ImageHtml("medlogo.png",localFileName=mediaDir+"/medlogo.png"), navbar,idxbar, BR,quickbar, Chunk("",myId='sidebar')])
